...
export async function POST(request: Request) {
  try {
    ...
    try {
      ...
      return NextResponse.json(
        { error: 'Bu e-posta adresine ait hesap bulunamadı veya bir hata oluştu.' },
        { status: 400 }
      );
    }
      ...
      <body>
        <div class="container">
          <div class="card">
            ...
            <p class="text">
              Merhaba, <br><br>
              Readixon hesabınızın şifresini sıfırlamak için bir istek aldık. Aşağıdaki butona tıklayarak yeni bir şifre belirleyebilirsiniz.
            </p>
            <a href="${resetLink}" class="button">Şifremi Sıfırla</a>
            <p class="text" style="font-size: 14px;">
              Eğer bu isteği siz yapmadıysanız, bu e-postayı güvenle görmezden gelebilirsiniz. Şifreniz siz yeni bir tane belirleyene kadar değişmeyecektir.
            </p>
            <div class="footer">
    ...
    const info = await transporter.sendMail({
      ...
      to: email,
      subject: 'Readixon - Şifre Sıfırlama İsteği',
      html: htmlTemplate,
    });
