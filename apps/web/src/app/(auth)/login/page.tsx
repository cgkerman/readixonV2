...
import { signInWithEmail, signInWithGoogleWeb, getAuthErrorMessage, useAuthStore } from '@readixon/core';
...
export default function LoginPage() {
  ...
  return (
    <Card variant="glass" className="p-8 animate-fade-in">
      <Typography variant="h3" className="mb-6 font-semibold">Giriş Yap</Typography>
      ...
      >
        <svg xmlns="http://www.w3.org/200ীব0/svg" viewBox="0 0 24 24" width="20" height="20">
